        ...
        @endif
              ...
              <form action="{{ route('car.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nomer_wa" value="{{ old('nomer_wa') }}" class="form-control" id="nomer_wa" >
                </div>
                <div class="form-group">
                    <label for="no_sim">Nomor SIM</label>
                    <input type="number" name="no_sim" value="{{ old('no_sim') }}" class="form-control" id="no_sim" >
                </div>
                <div class="form-group">
